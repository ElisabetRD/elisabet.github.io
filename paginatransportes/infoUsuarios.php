            ...
            <div class="container px-5 my-5 px-5">
                <div class="text-center mb-5">   <!--RESERVA AQUI-->
                  ...
                  <!--  <div class="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i class="bi bi-envelope"></i></div> -->
                    <h2 class="fw-bolder">Usuarios registrados</h2>
...
<?php foreach ($datos as $datos1) {?>
  <tr> 
    <th><?php echo $datos1['Id'];?> </th>
    <th><?php echo $datos1['Nombre'];?> </th>
    <th><?php echo $datos1['Apellido'];?> </th>
    <th><?php echo $datos1['Telefono'];?> </th>
    <th><?php echo $datos1['Edad'];?> </th>
    <th><?php echo $datos1['Sexo'];?> </th>
    <th><?php echo $datos1['Puesto'];?> </th>
    <th><?php echo $datos1['Contrasena'];?> </th> 
    <th><?php echo $datos1['Fecha_ingreso'];?> </th> 
    <td><?php echo "<button type='button' class='btn btn-danger' > <a href='eliminarUS.php?Id=".$datos1["Id"]."' class='link-body-emphasis link-offset-2 link-underline-opacity-25 link-underline-opacity-75-hover'>ELIMINAR</a></button>"?></td> 
